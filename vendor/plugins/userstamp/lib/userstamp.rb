...
#        base.before_filter  :set_stamper  # <-- put this directly into ApplicationController [mharris2 6/19/08]
      ...
      module InstanceMethods
        private
          ...
          def set_stamper
            User.stamper = @current_user  # self.current_user
                                          # changed to instance variable because otherwise student_login_required breaks [mharris2 6/19/08]
          end
