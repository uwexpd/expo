  ...
  */  var Chosen, get_side_border_padding, root;
  ...
  Chosen = (function() {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      this.f_width = this.f_width == 0 ? 500 : this.f_width /* Add by Josh Lin at 10-20-2011*/
      container_props = {
        'id': this.container_id,
        'class': "chzn-container " + (this.is_rtl ? 'chzn-rtl' : ''),
        'style': 'width: ' + this.f_width + 'px'
      };
      this.default_text = this.form_field.readAttribute('data_placeholder') ? this.form_field.readAttribute('data_placeholder') : this.default_text_default;
